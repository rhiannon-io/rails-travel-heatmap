...
# docker build -t rails_travel_heatmap .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name rails_travel_heatmap rails_travel_heatmap
